...
training_pipeline = TrainingPipeline(attention_model, primary_model, secondary_model)

# Chargement des datasets
dataset_loader = DatasetLoader(bw_dir='path/to/bw', color_dir='path/to/color')

# Entraînement du modèle d'attention
training_pipeline.train_attention_model(dataloader=dataset_loader, epochs=10, lr=0.001)
